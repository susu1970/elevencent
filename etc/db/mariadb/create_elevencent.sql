...
use `elevencent`;
drop user if exists 'elevencent'@'localhost';
create user 'elevencent'@'localhost' identified by '123456';
grant all on elevencent.* to 'elevencent'@'%' identified by '123456';
flush privileges;
