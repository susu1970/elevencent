...
#define RESOURCE_ID_LOOP_INCRE(resourceId) do{if(++resourceId==RESOURCE_ID_RANGE_MAX)resourceId=RESOURCE_ID_RANGE_MIN;}while(0)
  ...
  enum RESOURCE_MASK_USER:resource_mask_t{
    RESOURCE_MASK_USER_POST_SENDER=1<<1,
    RESOURCE_MASK_USER_POST_RECVER=1<<2,
    
    RESOURCE_MASK_USER_DFT=0,
  };
  enum RESOURCE_MASK_POST:resource_mask_t{
    RESOURCE_MASK_POST_SENDER=1<<1,
    RESOURCE_MASK_POST_RECVER=1<<2,
    RESOURCE_MASK_POST_READABLE=1<<3,
    RESOURCE_MASK_POST_WRITABLE=1<<4,            
  };
  enum RESOURCE_MASK_POST_CONTENT:resource_mask_t{
    RESOURCE_MASK_POST_CONTENT_TYPE_STRING=1<<1,
    RESOURCE_MASK_POST_CONTENT_TYPE_DFT=RESOURCE_MASK_POST_CONTENT_TYPE_STRING,    
  };
